...
import { closeKlientiPanel, klientiLoad, openKlientiPanel, renderKlientiList, renderKlientiPage, initKlienti, klientiNewAml } from './klienti/klienti.js';
...
function mountRoute(path) {
  ...
  if (view === 'dolozka') {
    ...
    else if (view === 'klienti') { host.innerHTML = renderKlientiPage(); initKlienti(); }
...
window.klientiLoad = klientiLoad; // + Doložka (menu klienta)
window.klientiNewAml = klientiNewAml; // + AML (menu klienta)
